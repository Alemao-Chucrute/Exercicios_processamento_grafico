...
//#endif
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Modificação de janela -- Guilherme", nullptr, nullptr);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		mat4 model = mat4(1); //matriz identidade
		//Translação
		model = translate(model,vec3(600.0, 450.0, 0.0));
		//Rotação
		//model = rotate (model,radians(angulo*5.0f), vec3(0.0,0.0,1.0));
		//Escala
		model = scale(model,vec3(200.0, 200.0, 1.0));
		//Enviar para o shader
		glUniformMatrix4fv(glGetUniformLocation(shaderID, "model"), 1, GL_FALSE, value_ptr(model));
		...
		//Translação
		model = translate(model,vec3(200.0, 450.0, 0.0));
		//Rotação
		//model = rotate (model,radians(angulo*5.0f), vec3(0.0,0.0,1.0));
		//Escala
		model = scale(model,vec3(200.0, 200.0, 1.0));
        ...
        model = mat4(1); //matriz identidade
		//Translação
		model = translate(model,vec3(600.0, 150.0, 0.0));
		//Rotação
		//model = rotate (model,radians(angulo*5.0f), vec3(0.0,0.0,1.0));
		//Escala
		model = scale(model,vec3(200.0, 200.0, 1.0));
        ...
        model = mat4(1); //matriz identidade
		//Translação
		model = translate(model,vec3(200.0, 150.0, 0.0));
		//Rotação
		//model = rotate (model,radians(angulo*5.0f), vec3(0.0,0.0,1.0));
		//Escala
		model = scale(model,vec3(200.0, 200.0, 1.0));
